...
\begin{abstract}
	...
	\noindent A schedule was created to break this project down into manageable tasks. This report is the culmination of the fulfilment of many of those tasks. Not all tasks were fully realised, and further investigation can be carried out to extend the knowledge of this report. This report in its current state reflects the final studies, comparison results, and recommendations that have been achieved. \\ 
\end{abstract}
